...
class SharegptDatasetConverter(DatasetConverter):
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:
            ...
            aligned_messages.append(
                {
                    ...
                    "content": '' if message[self.dataset_attr.content_tag] is None else message[self.dataset_attr.content_tag],
                }
            )
        ...
        if self.dataset_attr.features:
            output["_features"] = example[self.dataset_attr.features]
        if self.dataset_attr.classes:
            output["_classes"] = example[self.dataset_attr.classes]
        return output
