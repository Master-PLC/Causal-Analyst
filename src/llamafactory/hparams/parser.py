...
_INFER_ARGS = [ModelArguments, DataArguments, FinetuningArguments, GeneratingArguments, CustomArguments]
_INFER_CLS = tuple[ModelArguments, DataArguments, FinetuningArguments, GeneratingArguments, CustomArguments]
_EVAL_ARGS = [ModelArguments, DataArguments, EvaluationArguments, FinetuningArguments, CustomArguments]
_EVAL_CLS = tuple[ModelArguments, DataArguments, EvaluationArguments, FinetuningArguments, CustomArguments]
...
def get_infer_args(args: Optional[Union[dict[str, Any], list[str]]] = None) -> _INFER_CLS:
    model_args, data_args, finetuning_args, generating_args, custom_args = _parse_infer_args(args)
    ...
    return model_args, data_args, finetuning_args, generating_args, custom_args
