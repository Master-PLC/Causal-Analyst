...
from .sft_custom import run_sft_custom
...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "sft_custom":
        run_sft_custom(model_args, data_args, training_args, finetuning_args, generating_args, custom_args, callbacks)
...
def export_model(args: Optional[dict[str, Any]] = None) -> None:
    model_args, data_args, finetuning_args, _, _ = get_infer_args(args)
